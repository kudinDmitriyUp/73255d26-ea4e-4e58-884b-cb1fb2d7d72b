...
export const metadata: Metadata = {
  title: "DuckBar - Authentic Ukrainian Bar & Lounge",
  description: "Experience authentic Ukrainian hospitality at DuckBar. Traditional vodka, homemade appetizers, and warm atmosphere in your local community.",
  keywords: "Ukrainian bar, local bar, traditional drinks, vodka, Ukrainian food, cozy bar atmosphere",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    ...
    description: "Join us for an unforgettable evening of authentic Ukrainian hospitality and traditional flavors.",
    type: "website",
    siteName: "DuckBar"
  },
  twitter: {
    ...
    title: "DuckBar - Authentic Ukrainian Bar",
    description: "Experience authentic Ukrainian hospitality and traditional flavors at DuckBar"
  }
};
